...
def _ssim(X, Y, win, data_range=255, size_average=True, full=True, K=(0.01,0.03), nonnegative_ssim=False):
...
def ssim(X, Y, win_size=11, win_sigma=1.5, win=None, data_range=255, size_average=True, full=True, K=(0.01, 0.03), nonnegative_ssim=False):
    r""" interface of ssim
    Args:
...
def ms_ssim(X, Y, win_size=11, win_sigma=4, win=None, data_range=255, size_average=True, full=False, weights=None, K=(0.2, 0.4), nonnegative_ssim=False):
